            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>$5.00</td>
                        <td><img style="width: 110px; height:120px;" src="../images/menu-momo.jpg" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                    ...
                    <tr>
                        ...
                        <td>$6.00</td>
                        <td><img style="width: 110px; height:120px;" src="../images//menu-pizza.jpg" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td><button type="button" class="btn btn-success">Update Food</button>  <button type="button" class="btn btn-danger">Delete Food</button></td>
                    ...
                    <tr>
                        ...
                        <td>Mixed Pizza</td>
                        <td>$10.00</td>
                        <td><img style="width: 110px; height:120px;" src="../images/menu-burger.jpg" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td><button type="button" class="btn btn-success">Update Food</button>  <button type="button" class="btn btn-danger">Delete Food</button></td>
